...
const columns: Column<TransactionsData>[] = [
    { header: '#OrderID', accessor: 'orderId', align: 'center',
        render: (item: TransactionsData)=>{
    ...
    { header: 'Transaction Date', accessor: 'transactionDate', align: 'center' },
...
const data: TransactionsData[] = [
    {
        ...
        quantity: 1,
        transactionId: "S3-4y7vdks34",
        transactionDate: "04-10-22  03:45:06",
        amount: CurrencyFormatter(25000),
        status: "Processing",
